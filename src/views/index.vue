        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="归属组织" prop="deptId">
              <el-tree-select v-model="form.deptId" :data="enabledDeptOptions" :props="{ value: 'id', label: 'label', children: 'children' }" value-key="id" placeholder="请选择归属组织" check-strictly />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
